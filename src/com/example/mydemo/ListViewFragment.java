...
//	    public MainActivity mainactvity;
//	    
...
//    
//	        this.mainactvity = (MainActivity) activity;
...
//
//	                mainactvity.getFadingActionBarHelper()
...
//								 mainactvity.finish();
//								 startActivityForResult(new Intent(mainactvity, HomeActivity.class), MAINFRAGMENT );
//								 mainactvity.overridePendingTransition(R.anim.scale_in, R.anim.fadeout);
//							}
//						};
...
//	                getActivity(), R.layout.item_home_menu_fragment,R.id.text,
//	                mListViewTitles));
//	    }
//
